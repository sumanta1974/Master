...
EOF
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "s3cmd get s3://${aws_s3_bucket.web_bucket.id}/website/Sumanta_logo_Vert.png .",
      "sudo cp /home/ec2-user/index.html /usr/share/nginx/html/index.html",
      "sudo cp /home/ec2-user/Sumanta_logo_Vert.png /usr/share/nginx/html/Sumanta_logo_Vert.png",
...
resource "aws_s3_bucket_object" "graphic" {
  bucket = "${aws_s3_bucket.web_bucket.bucket}"
  key    = "/website/Sumanta_logo_Vert.png"
  source = "./Sumanta_logo_Vert.png"
